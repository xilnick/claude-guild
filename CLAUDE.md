...
Refer to `guideline/guide/framework.md` for the core principles and mandatory requirements of the Guild system.

## Core Working Principles

Refer to `guideline/guide/framework.md` for the core working principles and recommended development workflow.
