...
## Purpose
Defines workflow execution patterns, stage configurations, and coordination strategies. This module is embedded into the setup command to enable intelligent workflow orchestration.
...
Context-Only Stages:
  reasoning:
    ...
    purpose: Task analysis and requirement clarification
