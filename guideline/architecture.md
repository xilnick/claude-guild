...
Global Commands (Cross-Project Interface):
  /guild:setup:
    ...
    - Analyzes project and generates project-specific system
...
Project-Specific Commands (Generated by Setup):
  /guild:
...
Directory Structure:
  .claude/
    commands/     
      - guild.md           # Generated project-specific workflow command
      - (global commands installed via NPM)
    agents/       
      guild/               # Generated project-specific agents
      
Communication Flow:
  1. Global commands provide consistent interface
  2. Project commands invoke project-specific agents
  3. Agents execute with embedded project intelligence
  4. Commands coordinate flow with project context
```
